...
<html>
    ...
    <body>
        ...
        <form method="post" action="subjectcredits.jsp">
            <table>
                <h2> <% out.println(session.getAttribute("dept")); %> department</h2>
                <%
                    rs1 = st1.executeQuery("select * from compulsary_subjects where dept='"+ session.getAttribute("dept") +"'");
                %>
                ...
                <tr><td>
                        ...
                        <%
                            ...
                            rs1 = st.executeQuery("select * from subjects where dept='"+ session.getAttribute("dept") +"' ");
                            while (rs1.next()) {
                                sub = rs1.getString(1);
                ...
                <%
                    ...
                    rs = st.executeQuery("select * from open_elective where dept='"+ session.getAttribute("dept") +"' ");
                    while (rs.next()) {
                        sub = rs.getString(1);
            ...
            <a href="selectstaff.jsp" class="btn"> Select Staff </a></br></br>
             <a href="indi.jsp" class="btn"> Show timetable</a>
