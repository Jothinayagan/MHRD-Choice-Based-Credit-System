...
<html>
    ...
    <body>
        <%
            String sub1 = "";
            String sub2 = "", sub3 = "", sub4 = "", ele1 = "", ele2 = "", oele1 = "", oele2 = "";
            ...
            try {
                ...
                ResultSet rs1, rs4;
                rs = st.executeQuery("select * from subjects where dept like '"+session.getAttribute("dept")+"'");

                ArrayList<String> ele = new ArrayList<String>();
                while (rs.next()) {
                    ele.add(rs.getString(1));
                }
                Statement st3 = cn.createStatement();
                rs1 = st3.executeQuery("select * from open_elective where dept like '"+session.getAttribute("user")+"'");
                ArrayList<String> oele = new ArrayList<String>();
                while (rs1.next()) {
                    oele.add(rs1.getString(1));
                }
                Statement st4 = cn.createStatement();
                rs4 = st4.executeQuery("select * from student_subjects where username like '"+session.getAttribute("user")+"' ");
                int x = 0;
                int y = 0;
                String a[] = {"FREE", "FREE", "FREE", "FREE"};
                while (rs4.next()) {
                    if (x > 3) {
                        if (ele.contains(rs4.getString(2)) || oele.contains(rs4.getString(2))) {                            
                            a[y] = rs4.getString(2);
                            y++;
                        }
                    }
                ...
                rs.close();
                ArrayList<String> csub = new ArrayList<String>();
                ResultSet rs5;
                Statement st5 = cn.createStatement();
                rs5 = st5.executeQuery("select * from compulsary_subjects where dept='"+session.getAttribute("dept")+"'");
                while (rs5.next()) {
                    csub.add(rs5.getString(1));
                }
                sub1=csub.get(0);
                sub2=csub.get(1);
                sub3=csub.get(2);
                ...
                day5[5] = oele1;
                day5[6] = oele2;
                day5[7] = "FREE";      //day1[0]=sub1; day1[1]=sub2; day1[2]=sub3; day1[3]=sub4; day1[4]=ele1; day1[5]=ele2; day1[6]=ele3;
