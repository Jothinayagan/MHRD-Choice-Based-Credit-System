    ...
    <body>
        ...
        <form method="post" action="subjectcredits.jsp">
            <table>
                ...
                <%
                    rs1 = st1.executeQuery("select * from compulsary_subjects where dept='ece' ");
                %>
                ...
                <tr><td>
                        ...
                        <%
                            ...
                            rs1 = st.executeQuery("select * from subjects where dept='ece'");
                            while (rs1.next()) {
                                sub = rs1.getString(1);
                ...
                <%
                    ...
                    rs = st.executeQuery("select * from open_elective  where dept='ece' ");
                    while (rs.next()) {
                        sub = rs.getString(1);
